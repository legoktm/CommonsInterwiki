...
def main(tool, **kwargs):
    path = '//tools.wmflabs.org/commonsinterwiki/bootstrap'
    if tool=='checker.py':
...
"""
        ...
        nav = """<li><a href="//www.wikidata.org/wiki/User:Legobot/properties.js/Archive">properties.js log</a></li>
<li><a href="//www.wikidata.org/wiki/User_talk:Legobot/properties.js">Requests</a></li>
<li class="active"><a href="//tools.wmflabs.org/commonsinterwiki/cgi-bin/main.py">copypaste.py</a></li>
"""
...
<link href="//tools.wmflabs.org/commonsinterwiki/local.css" rel="stylesheet">
